...
<div id="container">
        ...
        <form action="/TMC/TMCServlet" method="get" name="newDraw">
				...
				<table border="1" bordercolor="#000033" width="100%">
           	...
           	for(Draw d: drawList){
           	 ...
           	 %>
 						...
 						<input name="MatchNo<%=d.getMatchno()%>" type="hidden" value="<%=d.getMatchno()%>" />
			           	...
			           	<td><%=d.getTeam1Id()%></td>
			           	<td><%=d.getTeam2Id()%></td>
			           	<td><input name="venue<%=d.getMatchno()%>" type="text"></td>
			           	<td><input name="date<%=d.getMatchno()%>" type="date"></td>
			           	<%-- <td><%=d.getResult()%></td> --%>
...
<%}}} %>
				  ...
				  <input size="5" type="submit" type="submit" value="Update Match Schedule" />
